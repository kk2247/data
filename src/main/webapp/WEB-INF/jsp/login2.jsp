...
<html lang="en">
<head>
<title>Out Strip Sign In Form A Responsive Widget Template :: w3layouts</title>
<!-- Meta tag Keywords -->
...
<!-- Meta tag Keywords -->
<!-- css files -->
<link rel="stylesheet" href="http://127.0.0.1:8080/data/login2css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
<link rel="stylesheet" href="http://127.0.0.1:8080/data/login2css/style.css" type="text/css" media="all" /> <!-- Style-CSS -->
<!-- //css files -->
<!-- web-fonts -->
...
<div data-vide-bg="http://127.0.0.1:8080/data/login2video/video2">
	<div class="center-container">
		...
		<!--footer-->
		<div class="footer">
			<p>&copy; 2017 Out Strip Sign In Form. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
		</div>
		<!--//footer-->
	</div>
</div>
<!-- js -->
<script type="text/javascript" src="http://127.0.0.1:8080/data/login2js/jquery-2.1.4.min.js"></script>
<script src="http://127.0.0.1:8080/data/login2js/jquery.vide.min.js"></script>
<!-- //js -->
</body>
</html>