...
<img src="../Message/jsp/assets/img/about.png" >
	<!-- Border -->
		...
		<div class="container-fluid">
				...
				<nav>
						<ul class="box-primary-nav">
								<li class="box-label">KARMO</li>

								<li><a href="index.jsp">Home</a> <i class="lnr lnr-home"></i></li>
			...
			<div class="col-md-9">
				<div class="row portfolio_container">
					...
					<div class="col-md-4 photography">
						<a href="single-project.jsp" class="portfolio_item work-grid">
		...
		<div class="container">
			<div class="col-md-6 col-sm-12">
				<div class="row">
					...
					<a href="contact.jsp" class="default-btn"> Get in touch <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
				</div>
			</div>
